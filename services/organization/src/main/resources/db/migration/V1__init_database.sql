...
(
    ...
    organization_address_id uuid UNIQUE,  -- Foreign key to the a
    CONSTRAINT PK_3 PRIMARY KEY ( organization_id ),
    CONSTRAINT FK_14_1 FOREIGN KEY ( organization_address_id ) REFERENCES organization_address ( organization_address_id )
);
